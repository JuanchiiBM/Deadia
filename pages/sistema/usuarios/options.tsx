    ...
    return (
        <div className='w-full my-[50px] bg-background-200 h-[80px] flex justify-between p-5 rounded-lg shadow-md'>
            ...
            <I18nProvider locale='es-ES'>
                <DateRangePicker ref={dateRef} isDisabled={jsonIsLoading} visibleMonths={2} defaultValue={undefined} onChange={(e: any) => handlerDateInitial(e)} value={dateInitial} id='datepicker' labelPlacement='outside' maxValue={today(getLocalTimeZone())} className="max-w-xs transition-all hidden" classNames={{
