...
import { dateRangePickerStylesFullWidth } from '@/styles/dateRangePickerStyles';
        ...
        <>
            ...
            <div className='w-full m-0 flex gap-2'>
                <I18nProvider locale='es-ES'>
                    <DatePicker label="Fecha de Compra" value={dataForm.datePicker} onChange={(e) => { handleInputChange('datePicker', e) }} maxValue={today(getLocalTimeZone())} showMonthAndYearPickers labelPlacement='outside' variant='bordered' {...dateRangePickerStylesFullWidth} />
                </I18nProvider>
                ...
                {/*
                <I18nProvider locale='es-ES'>
                    <DatePicker label="Fecha de Vencimiento" value={dataForm.datePickerVencimiento} onChange={(e) => { handleInputChange('datePickerVencimiento', e) }} showMonthAndYearPickers labelPlacement='outside' variant='bordered' {...dateRangePickerStylesFullWidth} />
                </I18nProvider>
                */}
            </div>
