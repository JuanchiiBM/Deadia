...
const ModalResumen: React.FC<{dataForm: IUseFormInventoryRegister, jsonDataArticles: any, isLoadingArticles: boolean}> = ({ dataForm, jsonDataArticles, isLoadingArticles }) => {
